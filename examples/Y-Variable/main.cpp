...
void setup() {
    ...
    // Send a simple Y-Variable to the Calculator containing 10*sin(x)
    std::vector<uint8_t> tokens = {TOKEN_1, TOKEN_0, TOKEN_MUL, TOKEN_SIN, TOKEN_X};
    ti.sendYVar(0, tokens);
}
